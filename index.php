<?php 
/*
 Plugin Name: VW Mobile App Pro Posttype
 lugin URI: https://www.vwthemes.com/
 Description: Creating new post type for VW Mobile App Pro Theme.
 Author: VW Themes
 Version: 1.0
 Author URI: https://www.vwthemes.com/
*/

define( 'VW_MOBILE_APP_PRO_POSTTYPE_VERSION', '1.0' );
add_action( 'init', 'vw_mobile_app_pro_posttype_create_post_type' );

function vw_mobile_app_pro_posttype_create_post_type() {
  register_post_type( 'testimonials',
    array(
  		'labels' => array(
  			'name' => __( 'Testimonials','vw-mobile-app-pro-posttype' ),
  			'singular_name' => __( 'Testimonials','vw-mobile-app-pro-posttype' )
  		),
  ...
  register_post_type( 'team',
    array(
      'labels' => array(
        'name' => __( 'Our Team','vw-mobile-app-pro-posttype' ),
        'singular_name' => __( 'Our Team','vw-mobile-app-pro-posttype' )
      ),
        'capability_type' => 'post',
        'menu_icon'  => 'dashicons-businessman',
        'public' => true,
...
if (is_admin()){
    add_action('admin_menu', 'vw_mobile_app_pro_posttype_bn_testimonial_meta_box');
}
/* Adds a meta box for custom post */
function vw_mobile_app_pro_posttype_bn_testimonial_meta_callback( $post ) {
	wp_nonce_field( basename( __FILE__ ), 'vw_mobile_app_pro_posttype_posttype_testimonial_meta_nonce' );
  $bn_stored_meta = get_post_meta( $post->ID );
  if(!empty($bn_stored_meta['vw_mobile_app_pro_posttype_testimonial_desigstory'][0]))
      $bn_vw_mobile_app_pro_posttype_testimonial_desigstory = $bn_stored_meta['vw_mobile_app_pro_posttype_testimonial_desigstory'][0];
    else
      $bn_vw_mobile_app_pro_posttype_testimonial_desigstory = '';
	?>
	<div id="testimonials_custom_stuff">
		<table id="list">
			<tbody id="the-list" data-wp-lists="list:meta">
				<tr id="meta-1">
					<td class="left">
						<?php _e( 'Designation', 'vw-mobile-app-pro-posttype' )?>
					</td>
					<td class="left" >
						<input type="text" name="vw_mobile_app_pro_posttype_testimonial_desigstory" id="vw_mobile_app_pro_posttype_testimonial_desigstory" value="<?php echo esc_attr( $bn_vw_mobile_app_pro_posttype_testimonial_desigstory ); ?>" />
					</td>
				</tr>
			</tbody>
		</table>
...
add_action( 'save_post', 'vw_mobile_app_pro_posttype_bn_metadesig_save' );

/*------------------------- Team Section-----------------------------*/
/* Adds a meta box for Designation */
function vw_mobile_app_pro_posttype_bn_team_meta() {
    add_meta_box( 'vw_mobile_app_pro_posttype_bn_meta', __( 'Enter Details','vw-mobile-app-pro-posttype' ), 'vw_mobile_app_pro_posttype_ex_bn_meta_callback', 'team', 'normal', 'high' );
}
// Hook things in for admin
if (is_admin()){
    add_action('admin_menu', 'vw_mobile_app_pro_posttype_bn_team_meta');
}
/* Adds a meta box for custom post */
function vw_mobile_app_pro_posttype_ex_bn_meta_callback( $post ) {
    wp_nonce_field( basename( __FILE__ ), 'vw_mobile_app_pro_posttype_bn_nonce' );
    $bn_stored_meta = get_post_meta( $post->ID );
    ...
    <div id="agent_custom_stuff">
        <table id="list-table">         
            <tbody id="the-list" data-wp-lists="list:meta">
                <tr id="meta-1">
                    <td class="left">
                        <?php esc_html_e( 'Email', 'vw-mobile-app-pro-posttype' )?>
                    </td>
                    <td class="left" >
                ...
                <tr id="meta-2">
                    <td class="left">
                        <?php esc_html_e( 'Phone Number', 'vw-mobile-app-pro-posttype' )?>
                    </td>
                    <td class="left" >
                ...
                <tr id="meta-3">
                  <td class="left">
                    <?php esc_html_e( 'Facebook Url', 'vw-mobile-app-pro-posttype' )?>
                  </td>
                  <td class="left" >
                ...
                <tr id="meta-4">
                  <td class="left">
                    <?php esc_html_e( 'Linkedin URL', 'vw-mobile-app-pro-posttype' )?>
                  </td>
                  <td class="left" >
                ...
                <tr id="meta-5">
                  <td class="left">
                    <?php esc_html_e( 'Twitter Url', 'vw-mobile-app-pro-posttype' ); ?>
                  </td>
                  <td class="left" >
                ...
                <tr id="meta-6">
                  <td class="left">
                    <?php esc_html_e( 'GooglePlus URL', 'vw-mobile-app-pro-posttype' ); ?>
                  </td>
                  <td class="left" >
                ...
                <tr id="meta-7">
                  <td class="left">
                    <?php esc_html_e( 'Designation', 'vw-mobile-app-pro-posttype' ); ?>
                  </td>
                  <td class="left" >
...
add_action( 'save_post', 'vw_mobile_app_pro_posttype_ex_bn_metadesig_save' );

add_action( 'save_post', 'bn_meta_save' );
/* Saves the custom meta input */
function bn_meta_save( $post_id ) {
  if( isset( $_POST[ 'vw_mobile_app_pro_posttype_team_featured' ] )) {
      update_post_meta( $post_id, 'vw_mobile_app_pro_posttype_team_featured', esc_attr(1));
  }else{
    update_post_meta( $post_id, 'vw_mobile_app_pro_posttype_team_featured', esc_attr(0));
  }
}
/*------------------------ Team Shortcode --------------------------*/
function vw_mobile_app_pro_posttype_team_func( $atts ) {
    $team = ''; 
    $team = '<div class="row team_inner" id="team">';
      ...
      if ( $new->have_posts() ) :
        ...
        while ($new->have_posts()) : $new->the_post();
          ...
          $team .= '<div class="col-md-3 col-sm-2">
        ...
        $team = '<div id="team" class="team_wrap col-md-3 mt-3 mb-4"><h2 class="center">'.__('Not Found','vw-mobile-app-pro-posttype').'</h2></div>';
      endif;
    $team .= '</div>';
    return $team;
}
add_shortcode( 'vw-mobile-app-pro-team', 'vw_mobile_app_pro_posttype_team_func' );

/*------------------- Testimonial Shortcode -------------------------*/
function vw_mobile_app_pro_posttype_testimonials_func( $atts ) {
    $testimonial = ''; 
    $testimonial = '<div id="testimonials" class="testimonial_shortcodes"><div class="row">';
      ...
      if ( $new->have_posts() ) :
        ...
        while ($new->have_posts()) : $new->the_post();
          ...
          $thumb = wp_get_attachment_image_src( get_post_thumbnail_id($post_id), 'medium' );
          $url = $thumb['0'];
          $excerpt = vw_mobile_app_pro_string_limit_words(get_the_excerpt(),20);
          $designation = get_post_meta($post_id,'vw_mobile_app_pro_posttype_testimonial_desigstory',true);
        ...
        $testimonial = '<div id="testimonial" class="testimonial_wrap col-md-3 mt-3 mb-4"><h2 class="center">'.__('Not Found','vw-mobile-app-pro-posttype').'</h2></div>';
      endif;
    $testimonial .= '</div></div>';
    return $testimonial;
}
add_shortcode( 'vw-mobile-app-pro-testimonials', 'vw_mobile_app_pro_posttype_testimonials_func' );